...
test('Should correctly validate string when it is empty', () => {
...
test('Should correctly validate string when it is nullable', () => {
...
test('Should correctly validate string when use size', () => {
...
test('Should correctly validate string when is less than', () => {
...
test('Should correctly validate string when is greater than', () => {
